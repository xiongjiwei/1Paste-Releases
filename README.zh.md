...
**1Paste 是一款免费的 macOS 剪贴板管理器**，为你复制的一切保留可搜索的历史记录。它常驻在菜单栏，随时按下 <kbd>⌘⇧V</kbd> 就能翻出几分钟前甚至几天前复制的文本、图片、文件与富文本。作为快速、注重隐私、键盘优先的剪贴板工具，1Paste 所有数据只存在你的 Mac 上，不联网、不登录、不上传。
...
**1Paste 是什么？**
1Paste 是一款 macOS 菜单栏剪贴板管理器，会记录你复制的所有内容——文本、图片、文件、富文本——并支持搜索，让你随时用 <kbd>⌘⇧V</kbd> 再次粘贴。

**1Paste 免费吗？**
免费。下载即用。

**支持哪些 macOS 版本？**
macOS 26 或更新版本，支持 Apple Silicon 与 Intel。

**1Paste 会上传我的剪贴板数据吗？**
不会。所有内容只存在你的 Mac 上，不联网、不登录、不上传。

**怎么打开 1Paste？**
在任意应用里按下 <kbd>⌘⇧V</kbd> 即可唤出面板，快捷键也可自定义。

## 关键词

macOS 剪贴板管理器 · 剪贴板历史 · 粘贴管理 · 复制历史 · 菜单栏剪贴板工具 · macOS 效率工具 · <kbd>⌘⇧V</kbd>
